...
{
    runSequentialDownDigitsUpToMaxDigitsForBase(NumberBase::HEX, blinker,
                                                logger);
}
...
{
    runSequentialDigitsUpToMaxDigitsPaddedToMaxDigitsForBase(NumberBase::HEX,
                                                             blinker, logger);
}
...
{
    runSameDigitsUpToMaxDigitsPaddedToMaxDigitsForBase(NumberBase::HEX, blinker,
                                                       logger);
}
