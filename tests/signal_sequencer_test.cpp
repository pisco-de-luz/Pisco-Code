...
// {
//     sequence_stack.loadFromCode(CODE_0, NumberBase::DEC, 0);
//     check_next(SIGNAL_ELEMENT_ZERO_GAP);
// }

// TEST(SignalUnitsGroup, ShouldEncodeSingleDigitPositiveNumber)
// {
//     sequence_stack.loadFromCode(CODE_2, NumberBase::DEC, 0);
...
// {
//     sequence_stack.loadFromCode(CODE_NEG_7, NumberBase::DEC, 0);
...
// {
//     sequence_stack.loadFromCode(CODE_120, NumberBase::DEC, 5);
...
// {
//     sequence_stack.loadFromCode(CODE_12345, NumberBase::DEC, 0);
//     CHECK_EQUAL(5, sequence_stack.size());
//     check_next(signal_element_digit_peak(1));
//     check_next(signal_element_digit_peak(2));
...
// {
//     sequence_stack.loadFromCode(CODE_120, NumberBase::DEC, 0);
